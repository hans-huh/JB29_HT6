 ...
 * класса.
 */
// пожалуйста, просмотрите еще раз тему про класс Object, вы уже который раз не работаете с equals и hashCode
// на занятиях мы говорили, когда вы должны их переопределять (прямых указаний на переопределение этих методов не будет никогда)
